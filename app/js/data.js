...
const TYPES = [
  ...
  {
    key: "ロマンチスト", type: "ロマンティック型", definition: "現実をドラマっぽく演出したい",
  ...
  {
    key: "同志予報士", type: "同志型", definition: "価値観・理解で結ばれる",
  ...
  },
  {
    ...
    color: "#9B5DE5", accent: "#E5D4FF", motif: "くま / 沼",
...
const KEI = {
  ...
  "ピュア系":   { types: ["ピュアエンジェル", "一途ペンギン", "運命マジシャン", "ロマンチスト"], desc: "まっすぐで夢見がち" },
  "マイペース系": { types: ["チル仙人", "ミステリアス狼", "慎重うさぎ", "同志予報士"], desc: "自分の世界を大切に" },
  "アクティブ系": { types: ["バイブス警察", "ド直球ザウルス", "ときめきパパラッチ", "マブダチエイリアン"], desc: "勢いと刺激で動く" }
};

// 同点時の優先順位(questions.md より。希少タイプ優先)
const TIE_PRIORITY = [
  "ヤキモチモンスター", "ド直球ザウルス", "ミステリアス狼", "ロマンチスト",
  "マブダチエイリアン", "運命マジシャン", "ピュアエンジェル", "推し活ベビー",
  "バイブス警察", "ときめきパパラッチ", "情熱ラブゾンビ", "同志予報士",
