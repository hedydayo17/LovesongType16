...
// Z世代(10-40代)に通じる主要13ジャンル。
// 削除済(ファウンダー指示・選択率低い/通じない):
//   "ロック"(邦ロックで十分)/ "バンド" / "ジャズ/ソウル" /
//   "クラシック/インスト"(該当曲ゼロ)/ "アコースティック/弾き語り" /
//   "インディー"(Z世代に通じない、邦ロックと被る)
const GENRES = [
  "J-POP", "K-POP", "洋楽ポップ", "邦ロック",
  "R&B", "ヒップホップ/ラップ", "EDM/ダンス",
  "ボカロ", "アニソン", "シティポップ", "バラード",
  "女性アイドル", "男性アイドル"
];
...
const ARTIST_CLUSTERS = {
  ...
  "Official髭男dism": ["JPOP_MAIN"],
  "Mrs. GREEN APPLE": ["JPOP_MAIN"],
  "Vaundy": ["JPOP_MAIN", "INDIE_ROCK"],
  "優里": ["JPOP_MAIN"],
  "Saucy Dog": ["JPOP_MAIN", "INDIE_ROCK"],
  "back number": ["JPOP_MAIN"],
  "あいみょん": ["JPOP_MAIN", "INDIE_ROCK"],
  "King Gnu": ["JPOP_MAIN", "INDIE_ROCK"],
  "緑黄色社会": ["JPOP_MAIN", "INDIE_ROCK"],
  "藤井 風": ["JPOP_MAIN", "CITYPOP", "HIPHOP_RNB"],
  "米津玄師": ["JPOP_MAIN", "ROCK_CLASSIC"],
  "SEKAI NO OWARI": ["JPOP_MAIN", "ROCK_CLASSIC"],
  "スキマスイッチ": ["JPOP_MAIN", "ROCK_CLASSIC"],
  "Tani Yuuki": ["JPOP_MAIN"],
  "wacci": ["JPOP_MAIN"],
  "西野カナ": ["JPOP_MAIN", "DIVA_BALLAD"],
  "GReeeeN": ["JPOP_MAIN"],
  "FUNKY MONKEY BABYS": ["JPOP_MAIN"],
  "ナオト・インティライミ": ["JPOP_MAIN"],
  "Aqua Timez": ["JPOP_MAIN", "ROCK_CLASSIC"],
  "ケツメイシ": ["JPOP_MAIN", "HIPHOP_RNB"],
  ...
  "いきものがかり": ["JPOP_MAIN", "DIVA_BALLAD"],
  "つじあやの": ["JPOP_MAIN", "DIVA_BALLAD"],
  "広瀬香美": ["JPOP_MAIN", "DIVA_BALLAD"],
  "Rake": ["JPOP_MAIN", "DIVA_BALLAD"],
  "桐谷健太": ["JPOP_MAIN", "DIVA_BALLAD"],
  "河口恭吾": ["JPOP_MAIN", "DIVA_BALLAD"],
  "ZARD": ["JPOP_MAIN", "DIVA_BALLAD"],

  // ── インディー邦ロック(Kroi/TOMOO系のサブカル寄り)──
  "TOMOO": ["INDIE_ROCK"],
  "sumika": ["INDIE_ROCK", "JPOP_MAIN"],
  "羊文学": ["INDIE_ROCK"],
  "Tele": ["INDIE_ROCK"],
  "マカロニえんぴつ": ["INDIE_ROCK"],
  "君島大空": ["INDIE_ROCK"],
  "クリープハイプ": ["INDIE_ROCK"],
  "Hump Back": ["INDIE_ROCK"],
  "SHE'S": ["INDIE_ROCK"],
  "REISAI": ["INDIE_ROCK"],
  "reGretGirl": ["INDIE_ROCK"],
  "imase": ["INDIE_ROCK", "JPOP_MAIN"],
  "indigo la End": ["INDIE_ROCK"],
  "ずっと真夜中でいいのに。": ["ANISON_VOCALO", "INDIE_ROCK"],
  "yama": ["INDIE_ROCK", "ANISON_VOCALO"],
  "もさを。": ["INDIE_ROCK", "JPOP_MAIN"],
  "カネヨリマサル": ["INDIE_ROCK"],
  "マルシィ": ["INDIE_ROCK"],
  ...
  "なるみや": ["INDIE_ROCK"],
  "UMEILO": ["INDIE_ROCK"],
  "SIX LOUNGE": ["INDIE_ROCK"],
  "Suchmos": ["INDIE_ROCK", "CITYPOP", "HIPHOP_RNB"],
  "Lamp": ["INDIE_ROCK", "CITYPOP"],
  "Bonobos": ["INDIE_ROCK", "CITYPOP"],
  "椎名林檎": ["INDIE_ROCK", "JPOP_MAIN"],
  "星野源": ["INDIE_ROCK", "JPOP_MAIN"],
  "真心ブラザーズ": ["INDIE_ROCK", "ROCK_CLASSIC"],
  "『ユイカ』": ["INDIE_ROCK", "JPOP_MAIN"],
  "Friday Night Plans": ["INDIE_ROCK", "CITYPOP", "HIPHOP_RNB"],
  "SHISHAMO": ["INDIE_ROCK"],
  "amazarashi": ["INDIE_ROCK", "ROCK_CLASSIC"],
  "Cocco": ["INDIE_ROCK", "ROCK_CLASSIC"],

  // ── 邦ロック王道(Mr.Children/RADWIMPS/BUMP系)──
  "Mr.Children": ["ROCK_CLASSIC"],
  "RADWIMPS": ["ROCK_CLASSIC", "INDIE_ROCK"],
  "BUMP OF CHICKEN": ["ROCK_CLASSIC"],
  "UNISON SQUARE GARDEN": ["ROCK_CLASSIC", "INDIE_ROCK"],
  "スピッツ": ["ROCK_CLASSIC"],
  "ASIAN KUNG-FU GENERATION": ["ROCK_CLASSIC", "INDIE_ROCK"],
  "ONE OK ROCK": ["ROCK_CLASSIC"],
  "ポルノグラフィティ": ["ROCK_CLASSIC"],
  "GLAY": ["ROCK_CLASSIC"],
  "サザンオールスターズ": ["ROCK_CLASSIC", "CITYPOP"],
  "MONGOL800": ["ROCK_CLASSIC"],
  "HY": ["ROCK_CLASSIC"],
  "TUBE": ["ROCK_CLASSIC", "JPOP_MAIN"],
  "コブクロ": ["ROCK_CLASSIC", "JPOP_MAIN"],
  "WANIMA": ["ROCK_CLASSIC", "JPOP_MAIN"],
  "KANA-BOON": ["ROCK_CLASSIC", "INDIE_ROCK"],
  "山崎まさよし": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "尾崎豊": ["ROCK_CLASSIC"],
  "オフコース": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "CHAGE&ASKA": ["ROCK_CLASSIC"],
  "風": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "井上陽水": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "THE 虎舞竜": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "中島みゆき": ["ROCK_CLASSIC", "DIVA_BALLAD"],
  "米米CLUB": ["JPOP_MAIN", "ROCK_CLASSIC"],
  ...
  // ── アニソン・ボカロ ──
  "YOASOBI": ["ANISON_VOCALO", "JPOP_MAIN"],
  "LiSA": ["ANISON_VOCALO", "JPOP_MAIN"],
  "Aimer": ["ANISON_VOCALO", "DIVA_BALLAD"],
  "DECO*27": ["ANISON_VOCALO"],
  "HoneyWorks": ["ANISON_VOCALO"],
  "みきとP": ["ANISON_VOCALO"],
  "ヨルシカ": ["ANISON_VOCALO", "INDIE_ROCK"],
  "supercell": ["ANISON_VOCALO"],
  "Eve": ["ANISON_VOCALO", "INDIE_ROCK"],
  ...
  "Ado": ["ANISON_VOCALO", "JPOP_MAIN"],
  "なとり": ["INDIE_ROCK", "ANISON_VOCALO"],

  // ── ヒップホップ・R&B ──
  "Awich": ["HIPHOP_RNB"],
  "Creepy Nuts": ["HIPHOP_RNB", "JPOP_MAIN"],
  "BASI": ["HIPHOP_RNB"],
  "SIRUP": ["HIPHOP_RNB", "CITYPOP"],
  "iri": ["HIPHOP_RNB", "CITYPOP"],
  "ちゃんみな": ["HIPHOP_RNB", "JPOP_MAIN"],
  "TENDRE": ["HIPHOP_RNB", "CITYPOP"],
  "湘南乃風": ["HIPHOP_RNB", "JPOP_MAIN"],
  "加藤ミリヤ": ["HIPHOP_RNB", "DIVA_BALLAD"],

  // ── バラード歌姫 ──
  "MISIA": ["DIVA_BALLAD"],
  "aiko": ["DIVA_BALLAD", "JPOP_MAIN"],
  "中島美嘉": ["DIVA_BALLAD"],
  "絢香": ["DIVA_BALLAD", "JPOP_MAIN"],
  "JUJU": ["DIVA_BALLAD"],
  "Superfly": ["DIVA_BALLAD", "ROCK_CLASSIC"],
  "UA": ["DIVA_BALLAD", "INDIE_ROCK"],
  "手嶌葵": ["DIVA_BALLAD"],
  "平原綾香": ["DIVA_BALLAD"],
  "大原櫻子": ["DIVA_BALLAD", "JPOP_MAIN"],
  "YUI": ["DIVA_BALLAD", "ROCK_CLASSIC"],
  "YUKI": ["DIVA_BALLAD", "INDIE_ROCK"],
  "miwa": ["DIVA_BALLAD", "JPOP_MAIN"],
  "milet": ["DIVA_BALLAD"],
  "Uru": ["DIVA_BALLAD"],
  "玉置浩二": ["DIVA_BALLAD", "ROCK_CLASSIC"],
  "浜崎あゆみ": ["DIVA_BALLAD", "JPOP_MAIN"],
  "倖田來未": ["DIVA_BALLAD", "JPOP_MAIN"],
  "倉木麻衣": ["DIVA_BALLAD", "JPOP_MAIN"],
  "安室奈美恵": ["DIVA_BALLAD", "JPOP_MAIN"],
  "一青窈": ["DIVA_BALLAD"],
  "宇多田ヒカル": ["DIVA_BALLAD", "JPOP_MAIN"],
  "大塚愛": ["DIVA_BALLAD", "JPOP_MAIN"],
  "阿部真央": ["DIVA_BALLAD", "INDIE_ROCK"],
  "槇原敬之": ["DIVA_BALLAD", "JPOP_MAIN"],
