...
const ARTIST_CLUSTERS = {
  ...
  "Tani Yuuki": ["JPOP_MAIN", "HEISEI"],
  "wacci": ["JPOP_MAIN", "HEISEI"],
  "西野カナ": ["JPOP_MAIN", "DIVA_BALLAD", "HEISEI"],
  "GReeeeN": ["JPOP_MAIN", "HEISEI"],
  ...
  "サザンオールスターズ": ["ROCK_CLASSIC", "CITYPOP", "HEISEI"],
  ...
  "尾崎豊": ["ROCK_CLASSIC"],
  "オフコース": ["ROCK_CLASSIC", "DIVA_BALLAD", "HEISEI"],
  "CHAGE&ASKA": ["ROCK_CLASSIC"],
  "風": ["ROCK_CLASSIC", "DIVA_BALLAD", "HEISEI"],
  "井上陽水": ["ROCK_CLASSIC", "DIVA_BALLAD", "HEISEI"],
  "THE 虎舞竜": ["ROCK_CLASSIC", "DIVA_BALLAD", "HEISEI"],
  "中島みゆき": ["ROCK_CLASSIC", "DIVA_BALLAD", "HEISEI"],
  ...
  "milet": ["DIVA_BALLAD", "HEISEI"],
  "Uru": ["DIVA_BALLAD", "HEISEI"],
  "玉置浩二": ["DIVA_BALLAD", "ROCK_CLASSIC", "HEISEI"],
  ...
  "erica": ["DIVA_BALLAD"],
  "小林明子": ["DIVA_BALLAD", "HEISEI"],
  "イルカ": ["DIVA_BALLAD", "HEISEI"],
  "福山雅治": ["DIVA_BALLAD", "JPOP_MAIN", "HEISEI"],
  "平井堅": ["DIVA_BALLAD", "JPOP_MAIN", "HEISEI"],

  // ── シティポップ ──
  "竹内まりや": ["CITYPOP", "DIVA_BALLAD", "HEISEI"],
  "山下達郎": ["CITYPOP", "HEISEI"],
  "大滝詠一": ["CITYPOP", "HEISEI"],
  "杏里": ["CITYPOP", "HEISEI"],
  "松原みき": ["CITYPOP"],
  "松任谷由実": ["CITYPOP", "DIVA_BALLAD", "HEISEI"],
